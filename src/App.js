  ...
  return (
    <div className="city-selector">
      ...
      <div className='dropdowns'>
        ...
        <select value={selectedState} onChange={e => setSelectedState(e.target.value)} className='dropdown'>
          <option value="" disabled>
            Select State
          </option>
          {
        ...
        <select value={selectedCity} onChange={e => setSelectedCity(e.target.value)} className='dropdown'>
          <option value="" disabled>
            Select City
          </option>
          {
